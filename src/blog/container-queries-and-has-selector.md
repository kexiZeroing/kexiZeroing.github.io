...
- `size`: the query will be based on the _inline and block_ dimensions of the container.
- `inline-size`: the query will be based on the _inline_ dimensions of the container.
