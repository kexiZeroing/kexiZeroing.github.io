...
const CARDS = [
  {
    ...
    color: "#4CAF50",
    description:
      "A season of renewal, where flowers bloom, trees regain their leaves, and the world feels fresh and full of life.",
  },
  {
    id: "2",
    title: "Summer",
  ...
  },
  {
    ...
    color: "#795548",
    description:
      "A crisp and colorful transition, where leaves turn vibrant shades, the air cools, and nature prepares for rest.",
  },
  {
    id: "4",
    title: "Winter",
