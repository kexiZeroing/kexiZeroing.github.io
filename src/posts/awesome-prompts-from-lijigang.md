...
提示词使用 Lisp 编程语言来替代自然语言，好处就是清晰准确，AI 更易理解。所以理解这些提示词，需要对 Lisp 语言有一些了解。Lisp 是仅次于 Fortran 的第二古老的高级编程语言，名字来源于"LISt Processing"（列表处理）的缩写，最初设计用于人工智能研究。主要特点是**所有代码都是用括号包围的前缀表达式**。
