...
- CSS `unset` will remove all properties set directly on the matched element, and revert to inheriting from the cascade - like a parent element or `<body>`; CSS `initial` reverts to browser defaults.
