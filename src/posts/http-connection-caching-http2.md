...
`s-maxage` is similar to `max-age` but it applies to proxies (CDN) instead of clients. Web proxy caches work on the same principle, but a much larger scale.
...
<img alt="http/2" src="https://tva1.sinaimg.cn/large/008vxvgGly1h8alebcldyj318o0ncq5w.jpg" width="600" />
...
<img alt="multiplexing" src="https://tva1.sinaimg.cn/large/008vxvgGly1h8aquuwp3gj319o0dedhk.jpg" width="700" />
